      ...
      <div className="absolute inset-0 flex items-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            {movie.plot && (
              <p className="text-gray-300 mb-6 line-clamp-3">{movie.plot}</p>
            )}
            
            <div className="flex flex-wrap gap-4">
              <button
                onClick={handlePlay}
                className="flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-full transition"
              >
              ...
              <button
                ...
                className="flex items-center px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-full transition"
              >
